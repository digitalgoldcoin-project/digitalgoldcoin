...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s digitalgoldcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  digitalgoldcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded digitalgoldcoin transaction") + "\n" +
              "  digitalgoldcoin-tx [options] -create [commands]   " + _("Create hex-encoded digitalgoldcoin transaction") + "\n" +
              "\n";
