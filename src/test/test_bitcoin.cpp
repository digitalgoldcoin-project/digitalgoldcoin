...
#define BOOST_TEST_MODULE DigitalGoldCoin Test Suite
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_digitalgoldcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
