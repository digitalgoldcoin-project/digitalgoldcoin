...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/digitalgoldcoin-project/digitalgoldcoin>";
    const std::string URL_WEBSITE = "<https://digitalgoldcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("DigitalGoldCoin version %s\n", FormatFullVersion());
}
